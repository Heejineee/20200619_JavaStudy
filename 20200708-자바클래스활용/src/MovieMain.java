...
public class MovieMain extends JFrame implements ActionListener{
	...
	MovieMain() {	// 생성자(클래스 이름과 동일해야 함, return형 없음, 메모리에 저장시에 반드시 호출) 클래스엔 변수 선언, 값 넣기만 가능(반복문 같은 기능 사용은 메소드나 생성자에서 사용해야함)
		...
		try
		{
			URL url=new URL("https://t1.daumcdn.net/movie/e570ea3ccbe42a91fbcf026199dba27b3b018418");
