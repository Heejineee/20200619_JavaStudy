...
public class JoinForm extends JPanel{
	...
	public JoinForm()
	{
		...
		box1=new JCheckBox("육류");
		box2=new JCheckBox("채소류");
		box3=new JCheckBox("찌개");
		box4=new JCheckBox("달걀/유제품");
		box5=new JCheckBox("간식");
